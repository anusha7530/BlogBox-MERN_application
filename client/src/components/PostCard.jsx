...
export default function PostCard({post}) {
  return (
    <div className='group relative w-full border border-teal-500 h-[400px] overflow-hidden rounded-lg sm:w-[360px]  transition-all'>
      ...
      <div className='p-3 flex flex-col gap-2'>
        <p className='text-lg font-semibold dark:text-white line-clamp-2'>{post.title}</p>
        <span className='text-sm italic dark:text-white'>{post.category}</span>
